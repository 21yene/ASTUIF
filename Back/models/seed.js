...
const seedData = {
  student: [
    ...
    {
      fullname: "Tinsae Hunegnaw Ambaneh",
    ...
    {
      fullname: "Yehualashet Belayneh Eridaw",
      email: "yehualashet@gmail.com",
      password: "yehualashet",
      picture: null,
      year: "5",
      depId: 5,
    },
    {
      fullname: "Brook Fantahun Gebremeskel",
  ...
  staff: [
    ...
    {
      fullname: "Daniel Fantahun Gebremeskel",
  ...
  post: [
    {
      ...
      content:
        "Exciting news! We are launching a new product next week. Stay tuned for more updates.",
    ...
    },
    {
      ...
      content:
        "Join us this weekend for a charity event at the local community center. Let's make a difference together!",
    ...
    },
    {
      ...
      content:
        "We are excited to announce our partnership with a leading tech company. This collaboration will bring new opportunities for growth and innovation.",
    ...
    },
    {
      ...
      content:
        "Attention students! Don't forget to submit your applications for the upcoming internship program. This is a great opportunity to gain valuable work experience.",
      image: null,
      summarizable: false,
      eventLocation: "Astu Stadium",
    },
    {
      ...
      content:
        "Let's celebrate World Environment Day by planting trees in our community. Join us this Saturday at the local park.",
    ...
    },
    {
      ...
      content:
        "Exciting update! Our company has been nominated for the Best Employer of the Year award. We are proud of our team's dedication and hard work.",
      image: null,
      summarizable: false,
      rsvp: 0,
      eventLocation: "Astu Stadium",
    },
    {
      ...
      content:
        "Calling all talented artists! We are organizing an art competition with amazing prizes. Show us your creativity and passion.",
    ...
    },
    {
      ...
      content:
        "Are you interested in learning new languages? Join our language exchange program where you can meet language enthusiasts and improve your skills.",
      image: null,
      summarizable: false,
      rsvp: 0,
      eventLocation: "Astu Stadium",
    },
    {
      staffId: 9,
      categoryId: 9,
      staffName: "Daniel Fantahun Gebremeskel",
      content:
        "Save the date! Our annual conference will take place on November 15th. Get ready for inspiring talks and valuable networking opportunities.",
    ...
    },
    {
      ...
      content:
        "Attention graduates! We are organizing a career fair next month. Don't miss this chance to connect with top companies and explore job opportunities.",
      image: null,
      summarizable: false,
      rsvp: 0,
      eventLocation: "Astu Stadium",
